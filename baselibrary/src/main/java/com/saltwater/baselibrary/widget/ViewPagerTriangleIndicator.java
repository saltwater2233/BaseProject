package com.saltwater.baselibrary.widget;
...
public class ViewPagerTriangleIndicator extends LinearLayout {
    ...
    private String mColorSelected = "#333333";
    private String mColorUnSelected = "#666666";
    ...
    public void setPageTitle(List<String> titles) {
        ...
        if (mTitles != null && mTitles.size() > 0) {
            ...
            for (int i = 0; i < mTitles.size(); i++) {
                ...
                textView.setTextColor(Color.parseColor(mColorSelected));
                ...
                textView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ((TextView) v).setTextColor(Color.parseColor(mColorSelected));
                        setPageTitleHighColor(pageIndex);
    ...
    private void setInitPageTitlesColor() {
        ...
        for (int i = 0; i < totalView; i++) {
            ...
            if (view instanceof TextView) {
                ((TextView) view).setTextColor(Color.parseColor(mColorUnSelected));
    ...
    private void setPageTitleHighColor(int pos) {
        ...
        if (view instanceof TextView) {
            ((TextView) view).setTextColor(Color.parseColor(mColorSelected));
