package com.saltwater.modulecommon.widget;
...
public class PasswordEditText extends ClearEditText {
    ...
    //资源
    private final int INVISIBLE = R.mipmap.ic_common_edit_show_password;
    private final int VISIBLE = R.mipmap.ic_common_edit_hide_password;
    //按钮宽度dp
    private int mWidth;
    //按钮的bitmap
