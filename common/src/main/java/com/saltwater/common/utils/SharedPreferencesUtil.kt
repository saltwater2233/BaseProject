...
object SharedPreferencesUtil {
    ...
    fun put(key: String, data: Any) {
        val editor = BaseApplication.context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE).edit()
    ...
    operator fun get(key: String, defaultValue: String): String? {
        val sharedPreferences = BaseApplication.context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE)
